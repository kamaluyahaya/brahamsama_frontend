        ...
        >
          ...
          <div className="bg-slate-950 border-b border-slate-800 px-5 py-3.5 flex justify-between items-center shrink-0">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-extrabold text-xs uppercase tracking-widest text-slate-200">Client Profile Report Preview</h3>
            </div>
          ...
          <div className="flex-1 overflow-y-auto bg-slate-950 p-6 flex justify-center scrollbar-none">
            <div style={{ fontFamily: "'Inter', sans-serif", background: '#fff', width: '100%', maxWidth: '680px', display: 'flex', flexDirection: 'column', minHeight: '900px', boxShadow: '0 25px 60px rgba(0,0,0,0.5)', borderRadius: '4px' }}>
